<%@ Page Language="C#" MasterPageFile="~/MainPage.Master" AutoEventWireup="true" CodeBehind="UserHistoryEdit.aspx.cs" Inherits="regform.UserProfile.History.UserHistoryEdit" %>
            ...
            <div class="regConteiner">
                ...
                <div class="row">
                    ...
                    <div class="inputData">
                        ...
                        <asp:RequiredFieldValidator CssClass="error" runat="server" ControlToValidate="txtdestAddres" Text="+380" ErrorMessage="Phone should be not empty" Display="Dynamic"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="row">
                    <div class="title">Start Time:</div>
                    <div class="inputData">
                        <%--<input id="txtSDate" type="time" runat="server" value='<%#Bind("StartTime")%>' />--%>
                        <asp:TextBox ID="txtSDate" TextMode="DateTime" runat="server" Text='<%#Eval("StartTime") %>'></asp:TextBox>
                ...
                <div class="row">
                    ...
                    <div class="inputData">
                       <%-- <input id="txtFDate" type="time" runat="server" value='<%#Bind("FinishTime")%>' />--%>
                        
                        <asp:TextBox ID="txtFDate" TextMode="DateTime" runat="server" Text='<%#Eval("FinishTime") %>'></asp:TextBox>
                        <img src="../../Content/images/calender.png"/>
                    </div>
                </div>
