...
namespace AsyncClient.ServiceReference1 {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="MathResult", Namespace="http://schemas.datacontract.org/2004/07/DataContractServer")]
    ...
    public partial class MathResult : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        public double subrt {
            get {
                return this.subrtField;
            }
            set {
                if ((this.subrtField.Equals(value) != true)) {
                    this.subrtField = value;
                    this.RaisePropertyChanged("subrt");
                }
            }
        }
    ...
    public interface IMyMath {
        ...
        AsyncClient.ServiceReference1.MathResult Total(int x, int y);
        ...
        AsyncClient.ServiceReference1.MathResult EndTotal(System.IAsyncResult result);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IMyMathChannel : AsyncClient.ServiceReference1.IMyMath, System.ServiceModel.IClientChannel {
    }
    ...
    public partial class TotalCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        public AsyncClient.ServiceReference1.MathResult Result {
            get {
                base.RaiseExceptionIfNecessary();
                return ((AsyncClient.ServiceReference1.MathResult)(this.results[0]));
            }
        }
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class MyMathClient : System.ServiceModel.ClientBase<AsyncClient.ServiceReference1.IMyMath>, AsyncClient.ServiceReference1.IMyMath {
        ...
        public AsyncClient.ServiceReference1.MathResult Total(int x, int y) {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        public AsyncClient.ServiceReference1.MathResult EndTotal(System.IAsyncResult result) {
        ...
        private object[] OnEndTotal(System.IAsyncResult result) {
            AsyncClient.ServiceReference1.MathResult retVal = this.EndTotal(result);
            return new object[] {
                    retVal};
        }
